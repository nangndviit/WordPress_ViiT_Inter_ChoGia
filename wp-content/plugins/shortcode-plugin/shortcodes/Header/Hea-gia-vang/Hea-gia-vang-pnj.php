<?php
add_shortcode('shortcode_gia_vang_pnj', 'create_shortcode_gia_vang_pnj');
function create_shortcode_gia_vang_pnj()
{
    // Lấy dữ liệu từ API về giá vàng
    $api_url = 'https://apichogia.viit.com.vn/api/json/gia-vang?slug=vang-pnj';
