<?php
add_shortcode('shortcode_vay_tin_chat', 'create_shortcode_vay_tin_chat');
function create_shortcode_vay_tin_chat()
{
    // Lấy dữ liệu từ API về lãi suất
    $api_url = 'https://apichogia.viit.com.vn/api/json/lai-suat?slug=vay-tin-chap';
