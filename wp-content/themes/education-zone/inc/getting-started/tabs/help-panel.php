...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://rarathemes.com/previews/?theme=' . EDUCATION_ZONE_THEME_TEXTDOMAIN . '' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'education-zone' ); ?>" target="_blank">
